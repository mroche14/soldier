...
- DATABASE_URL or FOCAL_DATABASE_URL: PostgreSQL connection string for pgvector
"""

import os

from focal.config.models.storage import VectorStoreConfig
from focal.observability.logging import get_logger
from focal.vector.stores.base import VectorStore
...
def create_vector_store(config: VectorStoreConfig) -> VectorStore:
    ...
    if backend == "inmemory":
        ...
        # PostgresPool reads from DATABASE_URL or FOCAL_DATABASE_URL env vars
        pool = PostgresPool()
