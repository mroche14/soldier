...
from focal.api.dependencies import get_settings
from focal.api.exceptions import FocalAPIError
from focal.api.middleware.context import RequestContextMiddleware
from focal.api.middleware.rate_limit import RateLimitMiddleware
from focal.api.models.errors import ErrorBody, ErrorCode, ErrorDetail, ErrorResponse
from focal.api.routes import register_routes
...
def _register_exception_handlers(app: FastAPI) -> None:
    ...
    async def focal_api_error_handler(
        request: Request, exc: FocalAPIError
    ) -> JSONResponse:
        """Handle FocalAPIError and its subclasses."""
        logger.warning(
            "api_error",
