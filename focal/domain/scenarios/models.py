...
Contains Scenario and ScenarioStep models for multi-step conversational flows.
"""
...
from focal.domain.rules.models import AgentScopedModel, ToolBinding
...
class StepTransition(BaseModel):
    ...
    condition_fields: list[str] = Field(
        default_factory=list, description="Interlocutor fields in condition"
    )
