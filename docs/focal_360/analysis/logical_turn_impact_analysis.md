...
3. **Session mutex**: No concurrent pipeline runs for same `(tenant, agent, customer, channel)`
...
| Supersede-aware pipeline execution | 2 days | CRITICAL | LogicalTurnWorkflow |
