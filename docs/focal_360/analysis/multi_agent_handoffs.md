...
- `HandoffRequest` model in `PipelineResult`
...
### Pipeline Returns Handoff

```python
# Inside CognitivePipeline.run()
...
3. **Pipeline result supports handoff** - Already has `HandoffRequest`
