...
```python
from ruche.brains.focal.models.intent import Intent
...
```python
from ruche.brains.focal.retrieval.intent_retriever import IntentRetriever
...
- **Models**: `ruche/brains/focal/models/intent.py`
- **Retriever**: `ruche/brains/focal/retrieval/intent_retriever.py`
- **Store Interface**: `ruche/stores/agent_config_store.py`
- **Migration**: `alembic/versions/012_add_intents_table.py`
- **Tests**: `tests/unit/brains/focal/retrieval/test_intent_*.py`
