...
- [x] **Create ScenarioContribution model** (P6.4)
  - File: `ruche/brain/focal/planning/__init__.py` (new directory)
...
- [x] **Implement PAUSE detection logic**
  - File: `ruche/brain/focal/orchestration/orchestrator.py`
...
- [x] **Implement step skipping detection**
  - File: `ruche/brain/focal/filtering/scenario_filter.py`
...
- [x] **Create ScenarioOrchestrator class** (new)
  - File: `ruche/brain/focal/orchestration/__init__.py` (new directory)
...
- [ ] **Update FocalCognitivePipeline to use ScenarioOrchestrator**
  ...
  - Details:
    ```python
    # In __init__:
    from ruche.brain.focal.orchestration import ScenarioOrchestrator
...
- **Current Implementation**: `ruche/brain/focal/filtering/scenario_filter.py`
- **Models**: `ruche/brain/focal/models/scenario.py`, `ruche/brain/focal/filtering/models.py`
