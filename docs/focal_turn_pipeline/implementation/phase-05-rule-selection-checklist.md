...
**Status**: ✅ Mostly Implemented in `ruche/pipelines/focal/retrieval/rule_retriever.py`

### Tasks

- [x] **Review existing scope filtering logic**
  - File: `ruche/pipelines/focal/retrieval/rule_retriever.py`
  - Action: Reviewed
...
**What exists**:
- Binary filtering (applies: true/false) in `ruche/pipelines/focal/filtering/rule_filter.py`
...
- [x] **Create Jinja2 template for rule filtering**
  - File: `ruche/pipelines/focal/filtering/prompts/filter_rules.jinja2`
  - Action: Created
...
- [x] **Add Jinja2 environment setup**
  - File: `ruche/pipelines/focal/filtering/rule_filter.py`
  - Action: Modified
...
- [x] **Check if relationship model exists**
  - File: `ruche/pipelines/focal/models/rule_relationship.py`
  - Action: Completed
...
- [x] **Create RelationshipExpander class**
  - File: `ruche/pipelines/focal/filtering/relationship_expander.py`
  - Action: Completed
  - Details: Lines 16-113 implement RelationshipExpander with expand() method:
    ```python
    from ruche.pipelines.focal.models import Rule
    from ruche.pipelines.focal.models.relationship import RuleRelationship, RuleRelationshipKind
...
- [x] **Add Phase 5 logging**
  - File: `ruche/pipelines/focal/filtering/rule_filter.py`, `relationship_expander.py`
  - Action: Completed
...
- `ruche/pipelines/focal/filtering/rule_filter.py` - Current implementation
- `ruche/pipelines/focal/models/rule.py` - Rule model
...
**Models:**
- `ruche/pipelines/focal/models/rule_relationship.py`
- Updated: `ruche/pipelines/focal/filtering/models.py` (added RuleApplicability, RuleEvaluation)

**Core Implementation:**
- `ruche/pipelines/focal/filtering/prompts/filter_rules.jinja2`
- `ruche/pipelines/focal/filtering/relationship_expander.py`
- Updated: `ruche/pipelines/focal/filtering/rule_filter.py` (Jinja2 + ternary output)
- Updated: `ruche/pipelines/focal/stores/agent_config_store.py` (relationship methods)
- Updated: `ruche/pipelines/focal/stores/inmemory.py` (relationship implementation)
...
**Exports:**
- Updated: `ruche/pipelines/focal/models/__init__.py`
