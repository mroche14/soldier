...
- [x] **Create TurnContext model**
  - File: `ruche/pipelines/focal/models/turn_context.py`
...
- [x] **Create GlossaryItem model**
  - File: `ruche/pipelines/focal/models/glossary.py`
  - Action: Create new file
  - Details:
    ```python
...
- [x] **Create TurnInput model**
  - File: `ruche/pipelines/focal/models/turn_input.py`
...
- [x] **Add InterlocutorDataStore loader**
  - File: `ruche/pipelines/focal/loaders/__init__.py`
  - Action: Created new module
  - Details: Created `ruche/pipelines/focal/loaders/customer_data_loader.py`

- [x] **Implement CustomerDataLoader**
  - File: `ruche/pipelines/focal/loaders/customer_data_loader.py`
  - Action: Created new file
  - Details:
    ```python
...
- [x] **Add config loader for glossary and schema**
  - File: `ruche/pipelines/focal/loaders/static_config_loader.py`
  - Action: Created new file
  - Details:
    ```python
...
- [x] **Parallel loading already implemented in _build_turn_context**
  - File: `ruche/pipelines/focal/engine.py` (lines 1338-1449)
...
- `ruche/pipelines/focal/filtering/scenario_filter.py` - Updated imports
- `ruche/pipelines/focal/loaders/customer_data_loader.py` - Updated imports
- `ruche/pipelines/focal/migration/field_resolver.py` - Updated imports
- `ruche/pipelines/focal/migration/models.py` - Updated imports
...
1. **Updated process_turn signature** (`ruche/pipelines/focal/engine.py` lines 220-258)
...
2. **Added customer resolution** (`ruche/pipelines/focal/engine.py` lines 317-340)
...
3. **Added TurnContext building** (`ruche/pipelines/focal/engine.py` lines 389-409)
