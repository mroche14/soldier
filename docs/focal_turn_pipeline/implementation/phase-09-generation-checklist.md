...
- [x] **Create OutcomeCategory enum**
  - File: `soldier/alignment/models/outcome.py`
...
- [x] **Add LLM categories to GenerationResult**
  - File: `soldier/alignment/generation/models.py`
...
- [ ] **Convert system_prompt.txt to Jinja2**
  - File: `soldier/alignment/generation/prompts/response_generator.jinja2`
...
- [ ] **Create Jinja2 template loader**
  - File: `soldier/alignment/generation/template_loader.py`
  - Action: Create new file
  - Details:
    ```python
    import jinja2
...
- [ ] **Add ResponsePlan to PromptBuilder**
  - File: `soldier/alignment/generation/prompt_builder.py`
  - Action: Modify
  - Details:
...
- [ ] **Create ChannelFormatter abstract class**
  - File: `soldier/alignment/generation/formatters/__init__.py`
...
- [ ] **Implement WhatsAppFormatter**
  - File: `soldier/alignment/generation/formatters/whatsapp.py`
  - Action: Create
  - Details:
...
- [ ] **Implement EmailFormatter**
  - File: `soldier/alignment/generation/formatters/email.py`
  - Action: Create
  - Details:
...
- [ ] **Implement SMSFormatter**
  - File: `soldier/alignment/generation/formatters/sms.py`
  - Action: Create
  - Details:
...
- [ ] **Implement DefaultFormatter**
  - File: `soldier/alignment/generation/formatters/default.py`
  - Action: Create
  - Details:
...
- [ ] **Create LLM output parser**
  - File: `soldier/alignment/generation/parser.py`
  - Action: Create
  - Details:
    ```python
    import json
...
- [ ] **Add parsing to ResponseGenerator.generate()**
  - File: `soldier/alignment/generation/generator.py`
  - Action: Modify
  - Details:
    - Import parser
...
- [ ] **Create resolution determiner**
  - File: `soldier/alignment/generation/resolution.py`
  - Action: Create
  - Details:
    ```python
