...
- [x] **Add optional reranker to `ScenarioRetriever.__init__()`**
  - File: `ruche/pipelines/focal/retrieval/scenario_retriever.py`
  - Action: Modified
  ...
  - Details:
    ```python
    from ruche.pipelines.focal.retrieval.reranker import ScenarioReranker
...
- [x] **Create `MemoryReranker` if not exists**
  ...
  - Details: Similar pattern to `RuleReranker` in `ruche/pipelines/focal/retrieval/reranker.py`
...
- [x] **Create `ruche/pipelines/focal/models/intent.py`**
  - File: `ruche/pipelines/focal/models/intent.py`
  - Action: Create
...
- [x] **Create `ruche/pipelines/focal/retrieval/intent_retriever.py`**
  - File: `ruche/pipelines/focal/retrieval/intent_retriever.py`
  - Action: Create
...
- **Current Code**:
  ...
  - `ruche/pipelines/focal/retrieval/scenario_retriever.py`
  - `ruche/memory/retrieval/retriever.py`
  - `ruche/pipelines/focal/engine.py` (lines 746-778 - sequential retrieval)
