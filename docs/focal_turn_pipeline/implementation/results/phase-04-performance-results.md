...
1. **Parallel Retrieval** (`soldier/alignment/engine.py`)
...
2. **BM25 Hybrid Retrieval**
   - `soldier/alignment/retrieval/rule_retriever.py` - BM25 + vector hybrid
   - `soldier/alignment/retrieval/scenario_retriever.py` - BM25 + vector hybrid
   - `soldier/memory/retrieval/retriever.py` - BM25 + vector hybrid

3. **Intent Retrieval**
   - `soldier/alignment/retrieval/intent_retriever.py` - Intent catalog lookup
...
- **Metrics Code**: `soldier/observability/metrics.py` (lines 189-215)
