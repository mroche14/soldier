...
- [ ] **Add enforcement_expression to ConfigStore queries**
  - File: `ruche/brain/focal/stores/config_store.py`
...
- [ ] **Create variable extraction service**
  - File: `ruche/brain/focal/enforcement/variable_extractor.py`
...
- [ ] **Create deterministic enforcement service**
  - File: `ruche/brain/focal/enforcement/deterministic_enforcer.py`
  - Action: Create new file
  - Details:
...
- [ ] **Create LLM-based enforcement service**
  - File: `ruche/brain/focal/enforcement/subjective_enforcer.py`
  - Action: Create new file
  - Details:
...
- [ ] **Create Jinja2 prompt template**
  - File: `ruche/brain/focal/enforcement/prompts/judge_rule_compliance.jinja2`
  - Action: Create new file
  - Details:
    ```jinja2
...
- [ ] **Add new dependencies to constructor**
  - File: `ruche/brain/focal/enforcement/validator.py`
...
- [ ] **Create relevance checking service**
  - File: `ruche/brain/focal/enforcement/relevance_verifier.py`
...
- [ ] **Create grounding checking service**
  - File: `ruche/brain/focal/enforcement/grounding_verifier.py`
  - Action: Create new file (optional feature)
  - Details:
...
### Existing Dependencies
  ...
  - `ruche.brain.focal.stores.config_store.ConfigStore` - Fetch GLOBAL rules
