...
- [ ] **Add enforcement_expression to ConfigStore queries**
  - File: `focal/alignment/stores/config_store.py`
...
- [ ] **Create variable extraction service**
  - File: `focal/alignment/enforcement/variable_extractor.py`
...
- [ ] **Create deterministic enforcement service**
  - File: `focal/alignment/enforcement/deterministic_enforcer.py`
  - Action: Create new file
  - Details:
...
- [ ] **Create LLM-based enforcement service**
  - File: `focal/alignment/enforcement/subjective_enforcer.py`
  - Action: Create new file
  - Details:
...
- [ ] **Create Jinja2 prompt template**
  - File: `focal/alignment/enforcement/prompts/judge_rule_compliance.jinja2`
  - Action: Create new file
  - Details:
    ```jinja2
...
- [ ] **Add new dependencies to constructor**
  - File: `focal/alignment/enforcement/validator.py`
...
- [ ] **Create relevance checking service**
  - File: `focal/alignment/enforcement/relevance_verifier.py`
...
- [ ] **Create grounding checking service**
  - File: `focal/alignment/enforcement/grounding_verifier.py`
  - Action: Create new file (optional feature)
  - Details:
