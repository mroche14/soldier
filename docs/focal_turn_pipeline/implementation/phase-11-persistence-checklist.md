...
- [ ] **Add CustomerDataUpdate model**
  - File: `ruche/brain/focal/models/customer_data.py`
  - Action: Create
...
- [x] `OutcomeCategory` model - `ruche/brain/focal/models/outcome.py`
- [x] `TurnOutcome` model - `ruche/brain/focal/models/outcome.py`
- [x] `build_turn_outcome()` helper - `ruche/brain/focal/generation/resolution.py`
...
- [ ] **Add outcome field to TurnRecord**
  ...
  - Details: Add TurnOutcome field
    ```python
    from ruche.brain.focal.models.outcome import TurnOutcome
