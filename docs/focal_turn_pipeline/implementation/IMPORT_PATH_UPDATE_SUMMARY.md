...
|---------------|---------------|-------|
| `ruche/alignment/` | `ruche/pipelines/focal/` | ~250 |
| `ruche.alignment.` | `ruche.pipelines.focal.` | ~50 |
...
1. Use the updated paths in `ruche/pipelines/focal/` for alignment/cognitive pipeline code
