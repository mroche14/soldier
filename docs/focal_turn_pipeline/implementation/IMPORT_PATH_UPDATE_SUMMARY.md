...
|---------------|---------------|-------|
| `ruche/alignment/` | `ruche/brain/focal/` | ~250 |
| `ruche.alignment.` | `ruche.brain.focal.` | ~50 |
...
1. Use the updated paths in `ruche/brain/focal/` for alignment/cognitive pipeline code
