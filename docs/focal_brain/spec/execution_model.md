## 6. Brain Execution Model

This section defines which brain operations can execute **in parallel** vs **sequentially**.
...
└─── P1.5-P1.6: Parallel (InterlocutorDataStore ‖ Config/Glossary)
...
P11 (Persistence & Audit) ← PARALLEL:
     ...
     ├── InterlocutorDataStore persistence
     ├── TurnRecord write
...
|-------|---------------------|-------|
| **P1** | InterlocutorDataStore load ‖ Config load | Independent data sources |
