...
Every LLM task in the brain follows a **consistent configuration pattern**: configuration in TOML + prompt template in Jinja2.
...
|------|----------------|---------------|
| Situational Sensor | `[brain.situational_sensor]` | `situational/prompts/situational_sensor.jinja2` |
| Rule Filter | `[brain.rule_filtering]` | `retrieval/prompts/rule_filter.jinja2` |
| Scenario Filter | `[brain.scenario_filtering]` | `retrieval/prompts/scenario_filter.jinja2` |
| Response Generation | `[brain.generation]` | `generation/prompts/response_generator.jinja2` |
| LLM Judge | `[brain.enforcement]` | `enforcement/prompts/llm_judge.jinja2` |
| Entity Extraction | `[brain.memory_ingestion.entity_extraction]` | `memory/prompts/entity_extraction.jinja2` |
| Summarization | `[brain.memory_ingestion.summarization.*]` | `memory/prompts/summarization.jinja2` |
