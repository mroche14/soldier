...
> **Purpose**: Step-by-step guide for launching subagents to implement the focal turn brain.
...
4. **Ground themselves in the specs** - Read `docs/focal_brain/spec/` folder
...
1. `docs/focal_brain/implementation/SUBAGENT_PROTOCOL.md` - Execution rules
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections (CRITICAL)
5. `docs/focal_brain/implementation/phase-01-identification-checklist.md` - Your checklist
...
6. Update FocalBrain to build TurnContext
...
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-02-situational-sensor-checklist.md` - Your checklist
...
6. Add [brain.situational_sensor] config section
7. Integrate with FocalBrain (replace ContextExtractor)
8. Unit tests with 85%+ coverage
...
- Config model: SituationalSensorConfig in `ruche/config/models/brain.py`
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-04-retrieval-selection-checklist.md` - Your checklist
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-03-customer-data-update-checklist.md` - Your checklist
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-05-rule-selection-checklist.md` - Your checklist
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-06-scenario-orchestration-checklist.md` - Your checklist
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-07-tool-execution-checklist.md` - Your checklist
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-08-response-planning-checklist.md` - Your checklist
...
## Important Notes
- Phase 8 is currently SKIPPED in brain - this is the gap to fill
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/focal_brain/implementation/CHECKLIST_CORRECTIONS.md` - Naming corrections
5. `docs/focal_brain/implementation/phase-09-generation-checklist.md`
6. `docs/focal_brain/implementation/phase-10-enforcement-checklist.md`
7. `docs/focal_brain/implementation/phase-11-persistence-checklist.md`
