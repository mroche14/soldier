...
> **Reference**:
> - `docs/focal_brain/README.md` (Phase 4, Section 2)
> - `docs/focal_brain/analysis/gap_analysis.md` (Phase 4 analysis)
...
**Required** (focal_brain.md Section 6.5):
```python
...
- [x] **Refactor `FocalBrain._retrieve()` to use `asyncio.gather()`**
...
- [x] **Update `config/default.toml` with per-type reranking**
  ...
  - Details:
    ```toml
    [brain.retrieval.rule_reranking]
    enabled = true
    provider = "cohere"
    model = "rerank-english-v3.0"
    top_k = 20

    [brain.retrieval.scenario_reranking]
    enabled = false  # Optional - enable if needed

    [brain.retrieval.memory_reranking]
    enabled = true
    provider = "cohere"
    top_k = 10
...
### 3.3 Update FocalBrain to Pass Rerankers

- [x] **Construct rerankers in `FocalBrain.__init__()`**
  - File: `ruche/brains/focal/engine.py`
  - Action: Modify
...
- [x] **Integrate intent decision in FocalBrain**
  - File: `ruche/brains/focal/engine.py`
  - Action: Modify
...
- [x] **Document baseline performance (before Phase 4 changes)**
  - File: `docs/focal_brain/implementation/results/phase-04-performance-baseline.md`
  - Action: Created
...
- [x] **Document post-implementation performance**
  - File: `docs/focal_brain/implementation/results/phase-04-performance-results.md`
  - Action: Created
...
- [x] **Create intent registry documentation**
  ...
  - Details: Document intent catalog, retrieval, and analytics (per focal_brain.md note)
...
6. FocalBrain reranker construction (3.3)
...
- **Primary Spec**: `docs/focal_brain/README.md` (Phase 4, Section 2)
- **Gap Analysis**: `docs/focal_brain/analysis/gap_analysis.md` (Phase 4, lines 196-222)
