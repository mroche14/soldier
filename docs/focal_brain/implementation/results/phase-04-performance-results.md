...
```toml
[brain.retrieval.rule_hybrid]
enabled = true
vector_weight = 0.7
bm25_weight = 0.3
normalization = "min_max"

[brain.retrieval.scenario_hybrid]
enabled = true
vector_weight = 0.6
bm25_weight = 0.4
normalization = "min_max"

[brain.retrieval.memory_hybrid]
...
- **Baseline**: `docs/focal_brain/implementation/results/phase-04-performance-baseline.md`
- **Implementation Plan**: `IMPLEMENTATION_PLAN.md` (Phase 8)
- **Checklist**: `docs/focal_brain/implementation/phase-04-retrieval-selection-checklist.md`
