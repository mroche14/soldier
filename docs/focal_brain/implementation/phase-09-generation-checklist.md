...
> **Reference Documents**:
> - `docs/focal_brain/README.md` - Section on Phase 9 (P9.1-P9.5)
> - `docs/focal_brain/analysis/gap_analysis.md` - Phase 9 gaps
> - `IMPLEMENTATION_PLAN.md` - Phase 10 (Alignment Brain - Execution & Generation)
...
- [x] **Create OutcomeCategory enum**
  - File: `ruche/brains/focal/models/outcome.py`
  - Action: Create new file
  - **Implemented**: Already exists with all required categories (BRAIN and GENERATION categories)
  - Details:
    ```python
    ...
    class OutcomeCategory(str, Enum):
        ...
        Categories are set by different brain phases:
        - BRAIN categories: Set by Phases 7, 8, 10
        - GENERATION categories: Set by LLM in Phase 9
        """
        # Brain-set categories
...
- [x] **Create TurnOutcome model**
  ...
  - Details:
    ...
    class TurnOutcome(BaseModel):
        ...
        Categories accumulate throughout the brain:
        ...
        categories: list[OutcomeCategory] = Field(
            ...
            description="All semantic categories from brain and LLM"
        )
...
- [x] **Add LLM categories to GenerationResult**
  - File: `ruche/brains/focal/generation/models.py`
...
- [x] **Verify ResponsePlan model exists (blocker)**
  - File: `ruche/brains/focal/planning/models.py`
...
- [ ] **Convert system_prompt.txt to Jinja2**
  - File: `ruche/brains/focal/generation/prompts/response_generator.jinja2`
...
- [ ] **Create Jinja2 template loader**
  - File: `ruche/brains/focal/generation/template_loader.py`
  - Action: Create new file
  - Details:
    ```python
    import jinja2
...
- [ ] **Add ResponsePlan to PromptBuilder**
  - File: `ruche/brains/focal/generation/prompt_builder.py`
  - Action: Modify
  - Details:
...
- [ ] **Create ChannelFormatter abstract class**
  - File: `ruche/brains/focal/generation/formatters/__init__.py`
...
- [ ] **Implement WhatsAppFormatter**
  - File: `ruche/brains/focal/generation/formatters/whatsapp.py`
  - Action: Create
  - Details:
...
- [ ] **Implement EmailFormatter**
  - File: `ruche/brains/focal/generation/formatters/email.py`
  - Action: Create
  - Details:
...
- [ ] **Implement SMSFormatter**
  - File: `ruche/brains/focal/generation/formatters/sms.py`
  - Action: Create
  - Details:
...
- [ ] **Implement DefaultFormatter**
  - File: `ruche/brains/focal/generation/formatters/default.py`
  - Action: Create
  - Details:
...
- [ ] **Create LLM output parser**
  - File: `ruche/brains/focal/generation/parser.py`
  - Action: Create
  - Details:
    ```python
    import json
...
- [ ] **Add parsing to ResponseGenerator.generate()**
  - File: `ruche/brains/focal/generation/generator.py`
  - Action: Modify
  - Details:
    - Import parser
...
- [ ] **Create resolution determiner**
  - File: `ruche/brains/focal/generation/resolution.py`
  - Action: Create
  - Details:
    ```python
    ...
    def determine_resolution(
        ...
        Args:
            categories: All categories accumulated during brain
...
- [ ] **Create TurnOutcome builder**
  ...
  - Details:
    ...
    def build_turn_outcome(
        ...
        """Build complete TurnOutcome from brain state.

        Args:
            categories: All categories from brain and LLM
...
- [ ] **Add channel formatting config**
  ...
  - Action: Modify
  - Details: Add to `[brain.generation]` section:
    ```toml
    [brain.generation]
    enabled = true
...
### 8.2 Accumulate Categories Throughout Brain
...
- [ ] **Test full generation flow with categories**
  ...
  - Tests:
    ...
    - Categories accumulate through brain phases
...
7. **Engine Integration** (8.1-8.3) - Connect to brain
...
- [ ] Categories accumulate through brain phases (7, 8, 9, 10)
