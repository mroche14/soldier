...
> **Reference**: `docs/focal_brain/README.md` (Phase 6), `docs/focal_brain/analysis/gap_analysis.md` (P6.1-P6.4)
...
## Phase Breakdown (from ruche_turn_pipeline.md)
...
- [x] **Create ScenarioContribution model** (P6.4)
  - File: `ruche/brains/focal/planning/__init__.py` (new directory)
...
- [x] **Implement PAUSE detection logic**
  - File: `ruche/brains/focal/orchestration/orchestrator.py`
...
- [x] **Implement step skipping detection**
  - File: `ruche/brains/focal/filtering/scenario_filter.py`
  ...
  - Details:
    ...
    async def _find_furthest_reachable_step(
        ...
        scenario: Scenario,
        current_step_id: UUID,
        interlocutor_data: dict[str, Any],
        ...
        Args:
            ...
            interlocutor_data: Data from InterlocutorDataStore
        ...
        all_data = {**interlocutor_data, **session_variables}
...
- [x] **Create ScenarioOrchestrator class** (new)
  - File: `ruche/brains/focal/orchestration/__init__.py` (new directory)
...
### 5. FocalBrain Integration

- [ ] **Update FocalBrain to use ScenarioOrchestrator**
  - File: `ruche/brains/focal/engine.py`
  - Action: Replace ScenarioFilter with ScenarioOrchestrator
  - Details:
    ```python
    # In __init__:
    from ruche.brains.focal.orchestration import ScenarioOrchestrator
...
- ❌ Phase 8: Response Planning (BLOCKED - needs `ScenarioContributionPlan`)
  - **Critical**: Phase 8 is currently skipped entirely in the brain
...
- **Specification**: `docs/focal_brain/README.md` (Phase 6, lines 371-416)
- **Gap Analysis**: `docs/focal_brain/analysis/gap_analysis.md` (P6.1-P6.4, lines 240-256)
- **Current Implementation**: `ruche/brains/focal/filtering/scenario_filter.py`
- **Models**: `ruche/brains/focal/models/scenario.py`, `ruche/brains/focal/filtering/models.py`
