...
> **Reference Documents**:
> - `docs/focal_brain/README.md` (Phase 10, P10.1-P10.10)
> - `docs/focal_brain/analysis/gap_analysis.md` (Phase 10 gaps)
...
- [ ] **Add enforcement_expression field to Rule model**
  - File: `ruche/brains/focal/models/rule.py`
...
- [ ] **Add enforcement_expression to ConfigStore queries**
  - File: `ruche/brains/focal/stores/config_store.py`
...
- [ ] **Create variable extraction service**
  - File: `ruche/brains/focal/enforcement/variable_extractor.py`
  ...
  - Dependencies:
    - `re` (stdlib)
    - `ruche.runtime.models.session.Session`
    - `ruche.domain.interlocutor.models.InterlocutorDataStore`
...
- [ ] **Create deterministic enforcement service**
  - File: `ruche/brains/focal/enforcement/deterministic_enforcer.py`
  - Action: Create new file
  - Details:
...
- [ ] **Create LLM-based enforcement service**
  - File: `ruche/brains/focal/enforcement/subjective_enforcer.py`
  - Action: Create new file
  - Details:
...
- [ ] **Create Jinja2 prompt template**
  - File: `ruche/brains/focal/enforcement/prompts/judge_rule_compliance.jinja2`
  - Action: Create new file
  - Details:
    ```jinja2
...
- [ ] **Add new dependencies to constructor**
  - File: `ruche/brains/focal/enforcement/validator.py`
...
- [ ] **Create relevance checking service**
  - File: `ruche/brains/focal/enforcement/relevance_verifier.py`
...
- [ ] **Create grounding checking service**
  - File: `ruche/brains/focal/enforcement/grounding_verifier.py`
  - Action: Create new file (optional feature)
  - Details:
...
- [ ] **Add enforcement configuration to TOML**
  ...
  - Action: Update `[brain.enforcement]` section
  - Details:
    ```toml
    [brain.enforcement]
    enabled = true
...
### Existing Dependencies
  ...
  - `ruche.brains.focal.stores.config_store.ConfigStore` - Fetch GLOBAL rules
...
|----------|---------|----------------|
| `focal_brain.md` | Phase 10 | P10.1-P10.10 step breakdown |
