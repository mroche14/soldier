...
WAVE 1: Foundation (Quick Wins)          ← Wire existing infrastructure
    ↓
WAVE 2: Ingress & Safety                 ← Pre-brain layer (parallel)
    ↓
WAVE 3: Config & Channels                ← Brain extensions (parallel)
    ↓
...
4. **Ground themselves in the gap analysis** - Read `docs/acf/gap_analysis.md`
...
Every agent MUST read `docs/acf/gap_analysis.md` before implementing anything.
...
1. `docs/acf/SUBAGENT_PROTOCOL.md` - Execution rules
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Idempotency" section
5. `docs/acf/implementation/idempotency-checklist.md` - Your checklist (if exists)
...
### Agent 1B: Wire AgentConfig into Brain
...
```markdown
# Task: Integrate AgentConfig into Brain Config Resolution

## CRITICAL: Read These Files FIRST (in order)
1. `docs/acf/SUBAGENT_PROTOCOL.md` - Execution rules
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Config Hierarchy" section
5. `docs/acf/implementation/agent-config-checklist.md` - Your checklist (if exists)
...
- Model is defined but NOT integrated into brain
...
2. Merge agent overrides onto brain defaults
...
- [ ] Agent-specific config overrides brain defaults
...
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Ingress Control" section
5. `docs/acf/README.md` - Section 3 (Ingress Control concept)
6. `docs/acf/implementation/debouncing-checklist.md` - Your checklist (if exists)
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Ingress Control" section
5. `docs/acf/README.md` - Section 5 (Abuse firewall)
6. `docs/acf/implementation/abuse-detection-checklist.md` - Your checklist (if exists)
...
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Channel System" section
5. `docs/acf/README.md` - Section 7 (Channels)
6. `docs/acf/implementation/channel-capabilities-checklist.md` - Your checklist (if exists)
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Config Hierarchy" section
5. `docs/acf/implementation/scenario-config-checklist.md` - Your checklist (if exists)
...
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Side-Effect Registry" section
5. `docs/acf/README.md` - Section 4 (Side-Effect Registry)
6. `docs/acf/implementation/side-effect-registry-checklist.md` - Your checklist (if exists)
...
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Turn Cancellation" section
5. `docs/acf/README.md` - Section 3.4 (Irreversible checkpoints)
6. `docs/acf/implementation/turn-cancellation-checklist.md` - Your checklist (if exists)
...
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Agenda/Goals" section
5. `docs/acf/README.md` - Section 9 (Agenda, goals)
6. `docs/acf/implementation/agenda-goals-checklist.md` - Your checklist (if exists)
...
6. `docs/acf/implementation/hot-reload-checklist.md` - Your checklist (if exists)
...
2. `CLAUDE.md` - Project conventions
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Meta-Agents" section
5. `docs/acf/README.md` - Section 13 (Reporter agent)
6. `docs/acf/implementation/reporter-agent-checklist.md` - Your checklist (if exists)
...
3. `.specify/memory/constitution.md` - Hard rules
4. `docs/acf/gap_analysis.md` - See "Meta-Agents" section
5. `docs/acf/README.md` - Section 12 (ASA)
6. `docs/acf/implementation/asa-checklist.md` - Your checklist (if exists)
...
- [ ] Update `docs/acf/gap_analysis.md` with completion notes
...
- [Focal Turn Brain](../focal_brain/README.md) - The 11-phase brain this platform wraps
