"""InterlocutorDataRequirementExtractor - extracts customer data requirements from scenarios/rules.

Triggers InterlocutorDataSchemaExtraction workflow on Scenario/Rule create/update.
...
class InterlocutorDataRequirementExtractor:
    ...
    Usage:
        store = InterlocutorDataRequirementExtractor(
