...
from ruche.config.models.selection import SelectionStrategiesConfig
...
class Settings(BaseSettings):
    ...
    3. config/{RUCHE_ENV}.toml (environment overrides)
    4. RUCHE_* environment variables (runtime overrides)
    """
    ...
    app_name: str = Field(default="focal", description="Application name for logging/tracing")
    ...
    def settings_customise_sources(
        ...
        2. env_settings (RUCHE_* environment variables)
