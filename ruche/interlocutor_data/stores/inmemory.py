...
class InMemoryInterlocutorDataStore(InterlocutorDataStoreInterface):
    """In-memory implementation of InterlocutorDataStoreInterface for testing and development.
