...
class InterlocutorDataStoreCacheLayer(InterlocutorDataStoreInterface):
    """InterlocutorDataStoreInterface wrapper with Redis caching.
    ...
    def __init__(
        self,
        backend: InterlocutorDataStoreInterface,
        ...
        Args:
            backend: Underlying InterlocutorDataStoreInterface (usually PostgresInterlocutorDataStoreInterface)
