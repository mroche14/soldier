...
from ruche.brains.focal.phases.planning.models import ScenarioContributionPlan, ScenarioContribution
...
def sample_contribution_plan() -> ScenarioContributionPlan:
    ...
    from ruche.brains.focal.phases.planning.models import ContributionType
...
async def test_collect_from_scenario_steps_only(collector: ToolBindingCollector, sample_contribution_plan: ScenarioContributionPlan) -> None:
    ...
    from ruche.brains.focal.models.scenario import ScenarioStep
