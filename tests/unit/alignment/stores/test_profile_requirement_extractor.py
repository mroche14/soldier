"""Unit tests for InterlocutorDataRequirementExtractor.
...
from ruche.brains.focal.stores import InterlocutorDataRequirementExtractor
...
class TestScenarioExtractionHooks:
    ...
    async def test_save_scenario_triggers_extraction(
        ...
        wrapper = InterlocutorDataRequirementExtractor(
...
class TestPassThroughMethods:
    ...
    async def test_get_scenario_delegates(self, mock_config_store):
        ...
        wrapper = InterlocutorDataRequirementExtractor(config_store=mock_config_store)
        tenant_id = uuid4()
        scenario_id = uuid4()
...
class TestContentBuilding:
    ...
    def test_scenario_content_includes_name_and_description(self, sample_scenario):
        ...
        wrapper = InterlocutorDataRequirementExtractor(config_store=AsyncMock())
