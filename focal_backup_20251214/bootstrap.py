...
Example usage:
    ...
    from focal.bootstrap import bootstrap
...
from focal.observability.logging import get_logger, setup_logging
from focal.providers.embedding.jina import JinaEmbeddingProvider
from focal.providers.llm import create_executor, create_executors_from_pipeline_config
...
def bootstrap(
    ...
    # Configure LLM
    _model = model or os.environ.get("FOCAL_DEFAULT_MODEL", "openrouter/openai/gpt-oss-120b")
...
async def create_sample_scenario(
    ...
    Returns:
        Created Scenario
    """
    from focal.alignment.models import Scenario, ScenarioStep
