...
- Homepage is the MkDocs default; no Soldier context or links into the system.
...
1) **Foundational cleanup**
   - Replace `webdoc/docs/index.md` with a Soldier landing page derived from `README.md`, `docs/vision.md`, and `docs/architecture/overview.md`.
...
2) **Content sourcing and sync**
   ...
   - Add a short “How this maps to the codebase” block at the top of each major doc, pointing to the relevant modules (e.g., `soldier/alignment/engine.py`, `soldier/api/routes/chat.py`, `soldier/config/models/`).
...
- Core architecture and pipeline: `soldier/alignment/engine.py`, `soldier/alignment/result.py`, `soldier/alignment/*`.
- API surface: `soldier/api/app.py`, `soldier/api/routes/*`, `soldier/api/models/*`.
- Config models and loading: `soldier/config/models/*`, `soldier/config/loader.py`, `soldier/config/settings.py`.
- Stores and providers: `soldier/*/stores/*`, `soldier/providers/*`.
- Observability: `soldier/observability/*`.
