...
Handles mapping candidate variables from Situational Sensor to CustomerDataStore.
"""
...
class CustomerDataUpdater:
    ...
    def _validate_value(
        self, field_definition: CustomerDataField, raw_value: Any
    ) -> ValidationResult:
        """Validate and coerce a value using CustomerDataFieldValidator."""
