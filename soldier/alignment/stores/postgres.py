...
class PostgresAgentConfigStore(AgentConfigStore):
    ...
    def _row_to_scenario(self, row) -> Scenario:
        ...
        from soldier.alignment.models import ScenarioStep
    ...
    def _row_to_variable(self, row) -> Variable:
        ...
        from soldier.alignment.models import UpdatePolicy
    ...
    def _row_to_agent(self, row) -> Agent:
        ...
        from soldier.alignment.models.agent import AgentSettings
