"""Bootstrap module for easy Soldier setup.

Provides a simple way to initialize the full Soldier stack from config,
...
Example usage:
    ...
    from soldier.bootstrap import bootstrap
...
from soldier.observability.logging import get_logger, setup_logging
from soldier.providers.embedding.jina import JinaEmbeddingProvider
from soldier.providers.llm import create_executor, create_executors_from_pipeline_config
...
def bootstrap(
    ...
    # Configure LLM
    _model = model or os.environ.get("SOLDIER_DEFAULT_MODEL", "openrouter/openai/gpt-oss-120b")
