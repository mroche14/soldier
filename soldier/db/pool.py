...
class PostgresPool:
    ...
    def _get_dsn_from_env() -> str:
        ...
        dsn = os.environ.get("SOLDIER_DATABASE_URL")
        if dsn:
            return dsn
        ...
        user = os.environ.get("POSTGRES_USER", "soldier")
        password = os.environ.get("POSTGRES_PASSWORD", "soldier")
        database = os.environ.get("POSTGRES_DB", "soldier")
